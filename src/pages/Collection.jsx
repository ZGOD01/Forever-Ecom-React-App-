...
function Collection() {
  ...
  // Apply filters based on selected categories, subcategories, and search
  const applyFilter = () => {
  ...
  const sortProduct = () => {
    ...
    switch (sortType) {
      ...
      default:
        applyFilter(); // Ensure to reapply filters after sorting
        break;
    }
  };

  // Initialize filter products when products change
  useEffect(() => {

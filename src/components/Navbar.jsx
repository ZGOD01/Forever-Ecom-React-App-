...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
      <Link to="/Forever-Ecom-React-App-"><img src={assets.logo} className='w-36' alt="Logo" /></Link>

      <ul className='hidden sm:flex gap-5 text-sm text-gray-700'>
        <NavLink to='/Forever-Ecom-React-App-' className='flex flex-col items-center gap-1'>
          <p>HOME</p>
